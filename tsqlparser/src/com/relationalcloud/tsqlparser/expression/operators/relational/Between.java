...
public class Between implements Expression {
	...
	public void accept(RecursiveVisitor v) {
		...
		getBetweenExpressionStart().accept(v);
		getBetweenExpressionEnd().accept(v);
		v.visitEnd(this);
	}
	...
	public Object accept(RecursiveRewriterVisitor v) {
		v.visitBegin(this);
		Object l = leftExpression.accept(v);
		if (l != null)
			leftExpression = (Expression) l;
		Object s = betweenExpressionStart.accept(v);
		if (s != null)
			betweenExpressionStart = (Expression) s;
		Object e = betweenExpressionEnd.accept(v);
		if (e != null)
			betweenExpressionEnd = (Expression) e;
